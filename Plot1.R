...
par(mfrow=c(1,1))                                                                   #setting global settings
png(file="Plot1.png", height = 480, width = 480)                                    #creating png using file device
hist(as.numeric(req_set$Global_active_power),col="red",xlab="Global Active Power (kilowatts)",main="Global Active Power") #plotting histogram
